...
This repo is associated with the blog post ["Proportional Reward Sampling With GFlowNets"](https://sigmoidprime.com/post/gflownet/) over at [sigmoid prime](https://sigmoidprime.com). It contains an implementation of a Generative Flow Net (GFlowNet), proposed by Bengio et al. in the paper ["Flow Network based Generative Models for Non-Iterative Diverse Candidate Generation"](https://arxiv.org/abs/2106.04399) (2021).
